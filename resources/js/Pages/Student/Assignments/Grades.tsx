...
export default function AssignmentsGrades() {
    return (
        <AuthenticatedLayout>
            <Head title="Nilai Tugas - Mahasiswa" />
            ...
            <div className="flex min-h-[calc(100vh-4rem)] bg-slate-50/50">
                ...
                <div className="flex-1 min-w-0 p-6 md:p-8 space-y-6 max-w-7xl">
                    <Title
                        title="Nilai Tugas & Evaluasi"
                        subtitle="Daftar perolehan nilai dan umpan balik praktikum"
                    />
                    ...
                    <div className="rounded-2xl bg-white border border-slate-200/80 p-8 text-center space-y-3">
                        ...
                        <h3 className="text-lg font-semibold text-slate-800">Daftar Nilai Belum Tersedia</h3>
                        <p className="text-sm text-slate-500 max-w-md mx-auto">
                            Nilai dan rubrik penilaian dari Asisten Laboratorium akan ditampilkan di halaman ini setelah penilaian selesai.
                        </p>
                    </div>
                </div>
            </div>
